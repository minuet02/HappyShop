<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CategoryItem.aspx.cs" Inherits="CategoryItem" %>
...
<body>
    ...
    <div>
        ...
        <div id="ContentCol">        
         <div class="ContentNav" id="ContentNav"><span>当前的位置</span> <img src="Image/sign.gif" width="13" height="13" /><asp:Label ID="CategoryName" Text="" runat="server"></asp:Label></div>
